...
ChapMan ver 1.0 
====================================================================================================================
CREATORS: LY HA, ELIZABETH LUU, BRITTNEY NGUYEN
====================================================================================================================
...
- Have the latest verson of XCode installed and an Apple ID in order for the app the fully function
- Download all the files in the ChapMan Folder.
- Open Xcode and then open the Chap Man folder
- Sign in to your Apple ID by clicking "Xcode" in the top menu bar then "Preferences"
====================================================================================================================
VIEW SOURCE CODE
- Click the "ChapMan" folder
- Click the "ChapMan" folder once again
- Click the "View Controllers" folder
- All the code for the different classes used are in this folder to view
- Connect to an apple device and click "Trust" on degsignated Apple device and then build app on the device

*IN CASE THERE ARE ERRORS WHEN BUILDING PROJECT
  - Go to Signing and Capabilities and select a team
====================================================================================================================
...
Any legal action of whatever nature brought by either you or us (collectively, the “Parties” and individually, a “Party”) shall be commenced or prosecuted in the state and federal courts located in Harris County, Texas, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Terms of Use. In no event shall any claim, action, or proceeding brought by either Party related in any way to the Site be commenced more than one (1) years after the cause of action arose.
